...
df5 = df5.reset_index()
df5["cases per 1 mil"] = df5.groupby(["continentExp"])["cases per 1 mil"].apply(
    lambda x: x.cumsum()
)
df5["deaths per 1 mil"] = df5.groupby(["continentExp"])["deaths per 1 mil"].apply(
    lambda x: x.cumsum()
)
        ...
        dbc.Container(
            [
                dbc.Row(
                    [
                        dbc.Col(
                            html.H1(children="COVID-19 Worldwide at a glance"),
                            className="mb-2",
                        )
                    ]
                ),
                dbc.Row(
                    [
                        dbc.Col(
                            html.H6(children="Visualising trends across the world"),
                            className="mb-4",
                        )
                    ]
                ),
                ...
                dcc.Dropdown(
                    ...
                    options=[
                        {
                            "label": "Cases per 1 million people",
                            "value": "cases per 1 mil",
                        },
                        {
                            "label": "Deaths per 1 million people",
                            "value": "deaths per 1 mil",
                        },
                    ],
                    value="cases per 1 mil",
                    # multi=True,
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            dbc.Card(
                                html.H3(
                                    children="Daily figures by continent (per 1 million people)",
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            html.H5(
                                children="Latest update: 7 June 2020",
                        ...
                        dbc.Col(
                            html.H5(
                                children="Daily figures since 31 Dec 2019",
                                className="text-center",
                            ),
                            width=8,
                            className="mt-4",
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            dbc.Card(
                                html.H3(
                                    children="Cumulative figures by continent (per 1 million people)",
                                    className="text-center text-light bg-dark",
                                ),
                                body=True,
                                color="dark",
                ...
                dbc.Row(
                    [
                        ...
                        dbc.Col(
                            html.H5(
                                children="Cumulative figures since 31 Dec 2019",
                                className="text-center",
                            ),
                            width=8,
                            className="mt-4",
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            dbc.Card(
                                html.H3(
                                    children="Figures by country (per 1 million people)",
                                    className="text-center text-light bg-dark",
                                ),
                                body=True,
                                color="dark",
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            html.H5(children="Daily figures", className="text-center"),
                            className="mt-4",
                        ),
                    ]
                ),
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            html.H5(
                                children="Cumulative figures", className="text-center"
                            ),
                            className="mt-4",
                        ),
                    ]
...
@app.callback(
    [
        Output("pie_cases_or_deaths", "figure"),
...
def update_graph(choice):
    ...
    for col in dff.columns:
        fig2.add_trace(
            go.Scatter(x=dff.index, y=dff[col].values, name=col, mode="markers+lines")
        )
    ...
    for col in dff2.columns:
        fig4.add_trace(
            go.Scatter(x=dff2.index, y=dff2[col].values, name=col, mode="markers+lines")
        )
...
@app.callback(
    ...
    [Input("cases_or_deaths", "value"), Input("countries", "value")],
)
def update_graph(cases_or_deaths_name, countries_name):
    ...
    dfc2["cases per 1 mil"] = dfc2.groupby(["countriesAndTerritories"])[
        "cases per 1 mil"
    ].apply(lambda x: x.cumsum())
    dfc2["deaths per 1 mil"] = dfc2.groupby(["countriesAndTerritories"])[
        "deaths per 1 mil"
    ].apply(lambda x: x.cumsum())
    ...
    for col in dfc.columns:
        fig5.add_trace(
            go.Scatter(x=dfc.index, y=dfc[col].values, name=col, mode="markers+lines")
        )
    ...
    for col in dfc2.columns:
        fig6.add_trace(
            go.Scatter(x=dfc2.index, y=dfc2[col].values, name=col, mode="markers+lines")
        )
